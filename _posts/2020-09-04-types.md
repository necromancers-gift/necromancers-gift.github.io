...
In this blog post we will cover affinities(types) in the game. For all intends and purposes, affinities are just a game-specific term for types in other monster-catching games.
...
On the other hand, if a wind creatures attacks with an electric attack, no modifier is applied.
